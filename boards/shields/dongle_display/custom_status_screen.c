...
static struct zmk_widget_layer_status layer_stats_widget;
...
lv_obj_t *zmk_display_status_screen() {
    ...
    zmk_widget_layer_status_init(&layer_stats_widget, screen);
    // lv_obj_align(zmk_widget_layer_stats_obj(&layer_stats_widget), LV_ALIGN_BOTTOM_LEFT, 2, -18);
    lv_obj_align_to(zmk_widget_layer_status_obj(&layer_stats_widget), zmk_widget_bongo_cat_obj(&bongo_cat_widget), LV_ALIGN_BOTTOM_MID, 0, 6);
